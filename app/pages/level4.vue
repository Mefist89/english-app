  ...
  >
    ...
    <div class="relative z-10 min-h-screen p-4 md:p-8">
      <div class="max-w-6xl mx-auto">
        ...
        <main
          class="bg-white/20 backdrop-blur-md rounded-3xl border border-white/30 shadow-xl p-4 md:p-8"
        >
          <ShadowGame />
        </main>
        ...
        <div class="flex justify-between items-center mt-8">
          ...
          <NuxtLink
            to="/level5"
            class="group inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-white font-semibold"
          >
            Next Level
