        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12">
          ...
          <div class="flex flex-col md:flex-row items-center gap-8 mb-10">
            ...
            <div class="w-40 md:w-52 shrink-0">
              <img
                src="/images/level5/banny-winter.png"
                alt="Bugs Bunny Winter"
            ...
            <div class="text-center md:text-left">
              <h1 class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600 mb-3">
                Well Done!
              </h1>
              ...
              <div class="flex items-center justify-center md:justify-start gap-1">
                <span v-for="i in 5" :key="i" class="text-4xl">
                  {{ i <= 5 ? '⭐' : '☆' }}
                </span>
              </div>
            </div>
          ...
          <div class="mb-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              >
                ...
                />
                <!-- Word -->
                <span class="font-bold text-gray-700 text-center text-lg">{{ word.name }}</span>
                <!-- Audio Button -->
                <button
...
const words = [
  { id: 1, name: 'Parka', image: '/images/level5/parka.png', audio: '/audio/level5/parka.mp3' },
  { id: 2, name: 'Scarf', image: '/images/level5/scarf.png', audio: '/audio/level5/scarf.mp3' },
  { id: 3, name: 'Boots', image: '/images/level5/boots.png', audio: '/audio/level5/boots.mp3' },
  { id: 4, name: 'Gloves', image: '/images/level5/Gloves.png', audio: '/audio/level5/gloves.mp3' },
  { id: 5, name: 'Cap', image: '/images/level5/cap.png', audio: '/audio/level5/cap.mp3' },
]
